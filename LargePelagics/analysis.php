...
<html xmlns="http://www.w3.org/1999/xhtml">
                ...
                if ($privcheck == "admin" || $privcheck == "moderator" && $usercheck != "" && $usercheck != NULL) {
                    ...
                    <form name="analysis" id="analysis" action="">
                        ...
                        <div id="production" style="display:none;">
                            <h2>Production</h2>
                            <label for="searchbox">Vessel AMAS: </label>
                            <input type="text" id="searchbox2" autocomplete="off" name="pvessel" />
                            <sup style="color:#f00;"><em>(Τype in the whole AMAS)</em></sup> <label for="pyear">Year: </label><input type="text" name="pyear" id="pyear" /> 
                            <div class="showamas2"></div>
                            <table>
                                <tr>
                                    <th><b>Vessel</b></th>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <br />
                                        <label>
                                            <input type="checkbox" name="pvcols[]" value="vessel.AMAS" id="pvcols_1" /> AMAS
                                        </label>
                                        <br />
                                        <label>
                                            <input type="checkbox" name="pvcols[]" value="vessel_name" id="pvcols_2" />
                                            Vessel Name
                                        </label>
                                        <br />
                                        <label>
                                            <input type="checkbox" name="pvcols[]" value="reg_no_state" id="pvcols_3" />
                                            Reg No State</label>
                                        <br />
                                        <label>
                                            <input type="checkbox" name="pvcols[]" value="port" id="pvcols_4" />
                                            Port</label>
                                        <br />
                                        <label>
                                            <input type="checkbox" name="pvcols[]" value="port_area" id="pvcols_5" />
                                            Port Area</label>
                                        <br />
                                        <label>
                                            <input type="checkbox" name="pvcols[]" value="grt" id="pvcols_6" />
                                            GRT</label>
                                        <br />
                                        <label>
                                            <input type="checkbox" name="pvcols[]" value="vl" id="pvcols_7" />
                                            VL</label>
                                        <br />
                                        <label>
                                            <input type="checkbox" name="pvcols[]" value="vlc" id="pvcols_8" />
                                            VLC</label>
                                        <br />
                                        <label>
                                            <input type="checkbox" name="pvcols[]" value="vw" id="pvcols_9" />
                                            VW</label>
                                        <br />
                                        <label>
                                            <input type="checkbox" name="pvcols[]" value="hp" id="pvcols_10" />
                                            HP</label>
                                        <br />
                                        <label>
                                            <input type="checkbox" name="pvcols[]" value="gears" id="pvcols_11" />
                                            Gears</label>
                                        <br />
                                        <label>
                                            <input type="checkbox" name="pvcols[]" value="navigation" id="pvcols_12" />
                                            Navigation</label>
                                        <br />
                                        <label>
                                            <input type="checkbox" name="pvcols[]" value="communication" id="pvcols_13" />
                                            Communication</label>
                                        <br />
                                    </td>
                                    <td>
    ...
    //                        });
                        ...
                        $('#searchbox2').keyup(function () {
                            $.post('getvessel.php', $("#searchbox2").serialize(), function (data) {
                                $('.showamas2').html(data);
                                if (metritis == 0) {
                                    $('.showamas2').show("slow");
                                    metritis++;
